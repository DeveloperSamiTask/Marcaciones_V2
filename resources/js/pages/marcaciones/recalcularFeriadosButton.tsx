...
export function RecalcularFeriadosButton({
    empresa,
    fechaInicio,
    fechaFin,
    empresas,
    ...
    const handleConfirmar = () => {
        if (!localEmpresa || !localDateRange?.from || !localDateRange?.to) {
            return;
        }

        setIsLoading(true);

        router.post(route('marcaciones.recalcular-feriados'), {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    <DialogTitle>Recálculo de saldo de feriados</DialogTitle>
                    <DialogDescription>
                        Calcula la jornada programada de los horarios con estado F.
                    </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                    ...
                    >
                        {isLoading ? 'Calculando...' : 'Calcular feriados'}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
