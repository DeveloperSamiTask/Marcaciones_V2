...
export default function IndexMarcacion({ marcaciones, empresas, filters }: { marcaciones: MarcacionEditado[]; empresas: Empresa[]; filters: Filters }) {
    ...
    const NoFiltersMessage = () => (
        <div className="flex flex-col items-center justify-center p-8">
            <div className="max-w-md space-y-4 text-center">
                ...
                <p className="text-muted-foreground text-sm">Selecciona una empresa, tipo y/o rango de fechas para ver las marcaciones editadas</p>
                <Button
                    variant="outline"
                    className="mt-4"
                    onClick={() => {
            ...
            <div className="flex flex-1 flex-col p-8">
                <div className="@container/main flex flex-1 flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-bold tracking-tight sm:text-4xl">Ediciones</h2>
                    </div>
                    ...
                    <Card>
                        <CardContent>
                            {!showData ? (
                                ...
                                <DataTable key="datatable-marcaciones" columns={columns} data={marcaciones} />
                            )}
                        </CardContent>
                    </Card>
                </div>
