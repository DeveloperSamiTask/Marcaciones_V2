...
export default function DownloadStarsoftTareo({ disabled = false, tareos, filters }: {disabled: boolean; tareos: ReporteTareo[]; filters: Filters}) {
    ...
    const download = async () => {
        try {
            ...
            const response = await fetch(route('reportes.tareo.download.estarsoft'), {
                method: 'POST',
                headers: {
            ...
            link.href = url;
            link.download = 'tareo_starsoft.xlsx';
    ...
    return (
        ...
        >
            ...
            {!processing ? 'Exportar a Estarsoft' : 'Exportando...'}
        </Button>
    );
}
