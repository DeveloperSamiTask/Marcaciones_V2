...
import { columnsExtra } from './columnsExtra';
...
export default function IndexPermiso({
    pendientes,
    aprobados,
    rechazados,
    empresas,
                ...
                <div className="@container/main flex flex-1 flex-col gap-6">
                    <div className="sticky top-0 z-10 grid py-2 gap-6 bg-background">
                        <div className="flex items-center justify-between">
                            <h2 className="text-2xl font-bold tracking-tight sm:text-4xl">Lista de permisos para horas extras</h2>
                        </div>
                            ...
                            <CardContent>
                                <TabsContent value="pendientes">
                                    {!showData ? (
                                        ...
                                        <DataTable key="datatable-permisos-pendientes" columns={columnsExtra} data={pendientes} />
                                    )}
                                </TabsContent>
                                ...
                                <TabsContent value="aprobados">
                                    {!showData ? (
                                        ...
                                        <DataTable key="datatable-permisos-aprobados" columns={columnsExtra} data={aprobados} />
                                    )}
                                </TabsContent>
                                ...
                                <TabsContent value="rechazados">
                                    {!showData ? (
                                        ...
                                        <DataTable key="datatable-permisos-rechazados" columns={columnsExtra} data={rechazados} />
                                    )}
                                </TabsContent>
                            </CardContent>
                        </Card>
