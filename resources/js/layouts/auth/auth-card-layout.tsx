...
export default function AuthCardLayout({
    ...
    return (
        <div className="bg-gradient-to-r from-lime-500 to-yellow-300 dark:from-yellow-300 dark:to-lime-500 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
