...
<body>
    ...
    <div style="page-break-inside: avoid;">
        <div style="text-align: center;">
            ...
            <p style="font-size:14px; text-align:left; margin-left: 50px;">ASUNTO&nbsp;&nbsp;&nbsp;&nbsp;: <strong>SUSPENSION POR
                ACUMULACION DE AMONESTACIONES</strong>
            </p>
            ...
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                ...
                comunicamos la decisión de la empresa
                de imponerle una sanción disciplinaria consistente en
                <strong>SUSPENSION POR ACUMULACION DE AMONESTACIONES</strong>
                en referencia a los hechos que describimos a continuación:
            </p>
            <li style="margin-left: 150px; margin-right: 230px;">Por acumulacion de amonestaciones.</li> </br>
			<br>

            <div style="text-align: center; margin-left: 50px;margin-right: 50px;">
                <table style="text-align: center: center; width:100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="font-size:16px; border: 1px solid black;">MES</th>
                            <th style="font-size:16px; border: 1px solid black;">FECHA</th>
                            <th style="font-size:16px; border: 1px solid black;">DESCRIPCION</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($amonestaciones as $item)
                        <tr>
                            <td style="font-size:16px; text-align:center; border: 1px solid black; text-transform: uppercase;">
                                {{ $item->fecha->isoFormat('MMMM') }}
                            </td>
                            <td style="font-size:16px; text-align:center; border: 1px solid black;">
                                {{ $item->fecha->format('d/m/Y') }}
                            </td>
                            <td style="font-size:16px; text-align:center; border: 1px solid black; uppercase">
            ...
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                Estos hechos representan un incumplimiento a las cláusulas del Reglamento Interno de Trabajo CAPITULO X
                artículo 42)
                “Medida disciplinaria o sanción es la acción correctiva tomando a través de los niveles de supervisión
                que sanciona la falta o faltas
                cometidas por uno o más colaboradores en contra de la disciplinaria”.
            </p>
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
            ...
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                Por esta razón, la empresa ha decidido proceder a sancionarlo con (1) días de <strong>Suspensión sin goce de
                ...
                pertinentes al respecto, siendo de su entera responsabilidad.
            </p>
    ...
    <div style="page-break-inside: avoid;">
        ...
        <div style="text-align: center;">
            ...
            <li style="margin-left: 150px; margin-right: 230px;">Por acumulacion de amonestaciones.</li>
			<br>
