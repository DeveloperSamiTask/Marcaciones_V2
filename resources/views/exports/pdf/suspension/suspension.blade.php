        ...
        <div style="page-break-inside: avoid;">
            <div style="text-align: center;">
                    ...
                    <table style="text-align: center: center; width:100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            @foreach ($amonestaciones as $item)
                                <tr>
                                    <td
                                        style="font-size:16px; text-align:center; border: 1px solid black; text-transform: uppercase;">
                ...
                <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                    ...
                    CAPITULO X
                    artículo 42)
                    “Medida disciplinaria o sanción es la acción correctiva tomando a través de los niveles de
                    supervisión
                ...
                @else
                    <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                        ...
                        de <strong>Suspensión sin goce de haber</strong>, que será efectiva desde el
            ...
            <div style="text-align: center;">
                ...
                @if ($fecha == $fechaFin)
                    <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                        ...
                        de <strong>Suspensión sin goce de haber</strong>, fecha que será efectiva el día
                        <strong>{{ $fecha }}</strong>.
                        Finalmente, se le exhorta a que hechos como este no vuelvan a suceder; caso contrario, se
                        tomarán medidas pertinentes al respecto, siendo de su entera responsabilidad.
                    </p>
