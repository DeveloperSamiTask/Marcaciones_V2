    ...
    <div style="display: flex; page-break-inside: avoid;">
        <div style="text-align: center;">
            ...
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                Por la presente comunicación, y en ejercicio de las facultades sancionadoras que nos reconoce la ley, le comunicamos
                ...
                <table style="text-align: center; width:100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-size:12px; text-align:center; border: 1px solid black;">{{ $marcacion->ingreso ? $marcacion->ingreso->format('H:i') : '' }}</td>
                            <td style="font-size:12px; text-align:center; border: 1px solid black;">{{ $marcacion->salida ? $marcacion->salida->format('H:i') : '' }}</td>
                            <td style="font-size:12px; text-align:center; border: 1px solid black;">{{ $marcacion->ingreso_refri ? $marcacion->ingreso_refri->format('H:i') : '' }}</td>
                            <td style="font-size:12px; text-align:center; border: 1px solid black;">{{ $marcacion->salida_refri ? $marcacion->salida_refri->format('H:i') : '' }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <br>
            <p style="text-align:justify; margin-left: 50px; margin-right: 50px;">
                Estos hechos representan un incumplimiento al reglamento interno de trabajo en Capitulo IV Artículo 21º Son faltas sujetas a sanción,
